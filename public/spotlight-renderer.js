...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function exitAppMode() {
    ...
    window.windowAPI
      .appModeEnd()
      .catch((err) => console.error("appModeEnd notify failed:", err));
  }
        ...
        case "Tab":
          ...
          if (e.altKey) {
            ...
            if (e.shiftKey) {
              ...
              selectedAppIndex =
                selectedAppIndex > 0 ? selectedAppIndex - 1 : apps.length - 1;
            } else {
              // Option+Tab で次のアプリへ
              selectedAppIndex =
                selectedAppIndex < apps.length - 1 ? selectedAppIndex + 1 : 0;
            }
            updateAppSelection();
          }
          break;
